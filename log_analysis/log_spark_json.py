"""
Extract log based on uuid from libvirt state or ovs state, 
and only parse the selected logs into json format. 
"""
...
#		print(uuid) 
	...
	logRDD = sc.textFile(logPathIn) # support wildcard with quatation, i.e. logPathIn = '/mypath/*/*/'
